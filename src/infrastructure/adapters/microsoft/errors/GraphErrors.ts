...
export class GraphError extends Error {
  ...
  isAuthenticationError(): boolean {
    ...
    return authErrors.includes(this.code as GraphErrorCode) || 
           this.statusCode === 401 || 
           this.statusCode === 403;
  }
  ...
  isRateLimitError(): boolean {
    return this.code === GraphErrorCode.REQUEST_THROTTLED || 
           this.statusCode === 429;
  }
  ...
  isNotFoundError(): boolean {
    const notFoundErrors = [
      ...
      GraphErrorCode.ITEM_NOT_FOUND
    ];
    
    return notFoundErrors.includes(this.code as GraphErrorCode) || 
           this.statusCode === 404;
  }
  ...
  isConflictError(): boolean {
    ...
    return conflictErrors.includes(this.code as GraphErrorCode) || 
           this.statusCode === 409;
  }
...
export function shouldRefreshToken(error: GraphError): boolean {
  return error.code === GraphErrorCode.INVALID_AUTH_TOKEN ||
